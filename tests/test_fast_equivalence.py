# copied from phoenix @094a171 tests/test_fast_equivalence.py on 2026-09-08; edits: package imports phoenix.* -> lattrack.*
...
from lattrack.fast_coconut import FastCoconut, FastSTokenizer
...
def main():
    ...
    from lattrack.attn_hooks import AttnHooks, ResidualHooks
