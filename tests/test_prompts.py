# copied from phoenix @094a171 tests/test_prompts.py on 2026-09-08; edits: minimal_pairs import and its candidate-swap cross-check block removed (module not copied)
